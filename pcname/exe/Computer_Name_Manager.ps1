...
if (-not $isAdmin) {
    [System.Windows.Forms.MessageBox]::Show("Administrator privileges required! Please run as Administrator.", "Access Denied", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
    exit
}

# Create main form
$form = New-Object System.Windows.Forms.Form
$form.Text = "Apex Inotech - Computer Name Manager"
...
$subtitleLabel.Text = "Change your computer name easily and securely"
...
$statusLabel.Text = "Ready to change computer name"
...
$changeButton.Add_Click({
    ...
    if ([string]::IsNullOrEmpty($newName)) {
        [System.Windows.Forms.MessageBox]::Show("Please enter a new computer name!", "Input Required", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Warning)
        return
    }
    if ($newName.Length -lt 3) {
        [System.Windows.Forms.MessageBox]::Show("Computer name must be at least 3 characters long!", "Invalid Name", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Warning)
        return
    }
    if ($newName -eq $env:COMPUTERNAME) {
        [System.Windows.Forms.MessageBox]::Show("New name is same as current name!", "No Change", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
        return
    }
    $result = [System.Windows.Forms.MessageBox]::Show("Are you sure you want to change the computer name to '$newName'?\n\nThis will require a system restart to take effect.", "Confirm Change", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
    if ($result -eq [System.Windows.Forms.DialogResult]::Yes) {
        try {
            $statusLabel.Text = "Changing computer name..."
            $statusLabel.ForeColor = [System.Drawing.Color]::Orange
            $form.Refresh()
            $computer = Get-WmiObject -Class Win32_ComputerSystem
            $computer.Rename($newName)
            $statusLabel.Text = "Computer name changed successfully!"
            $statusLabel.ForeColor = [System.Drawing.Color]::Green
            [System.Windows.Forms.MessageBox]::Show("Computer name changed successfully to '$newName'!\n\nPlease restart your computer for changes to take effect.", "Success", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
            $currentNameLabel.Text = $newName
            $newNameTextBox.Clear()
        } catch {
            $statusLabel.Text = "Error changing computer name!"
            $statusLabel.ForeColor = [System.Drawing.Color]::Red
            [System.Windows.Forms.MessageBox]::Show("Error changing computer name: " + $_.Exception.Message, "Error", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        }
    }
})
...
$refreshButton.Add_Click({
    $currentNameLabel.Text = $env:COMPUTERNAME
    $statusLabel.Text = "Current name refreshed"
    $statusLabel.ForeColor = [System.Drawing.Color]::DarkBlue
})
